...
class MoniEditName extends StatefulWidget {
  const MoniEditName({super.key});

  @override
  State<MoniEditName> createState() => _MoniEditNameState();
}

class _MoniEditNameState extends State<MoniEditName> {
  String email = '';
    ...
    if (user != null) {
      try {
        ...
        Navigator.pushReplacement(
          context,
          PageRouteBuilder(
            pageBuilder: (_, __, ___) => const Moniprof(),
