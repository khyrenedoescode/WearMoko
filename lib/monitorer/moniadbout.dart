...
class MoniAbout extends StatefulWidget {
  const MoniAbout({super.key});

  @override
  _MoniAboutState createState() => _MoniAboutState();
}

class _MoniAboutState extends State<MoniAbout> with TickerProviderStateMixin {
              ...
              child: Column(
                children: [
                  ...
                  _buildSection(
                    ...
                    content:
                        'Wearmoko is an IoT-integrated mobile app focused on people\'s safety. It features a GPS module, ESP32, and a Raspberry Pi with camera, enabling real-time location tracking and emergency monitoring. The app is designed to be user-friendly, reliable, and accessible for all.',
                  ),
