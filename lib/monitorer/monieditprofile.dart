...
import 'package:wearmokoapp/monitorer/monieditname.dart';
import 'package:wearmokoapp/monitorer/monieditnumber.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:google_fonts/google_fonts.dart'; // Google Fonts

class MoniEdit extends StatefulWidget {
  const MoniEdit({super.key});

  @override
  _MoniEditState createState() => _MoniEditState();
}

class _MoniEditState extends State<MoniEdit> {
  String fullName = '';
  String email = '';
  String phoneNumber = '';
                ...
                children: [
                  _buildProfileRow(
                    ...
                    () => Navigator.push(
                      context,
                      PageRouteBuilder(
                        pageBuilder: (_, __, ___) => const MoniEditName(),
