...
import 'package:wearmokoapp/devicewearer/deviceabout.dart';
import 'package:wearmokoapp/devicewearer/devicecirclemanagement.dart';
import 'package:wearmokoapp/devicewearer/deviceeditpass.dart';
import 'package:wearmokoapp/devicewearer/devicelocsharing.dart';
import 'package:wearmokoapp/devicewearer/devicenotif2.dart';
import 'package:wearmokoapp/devicewearer/devicepersonalinformation.dart';
...
class DeviceSettings extends StatelessWidget {
  ...
  void _showDeviceLogoutOverlay(BuildContext context) {
    showDialog(
      context: context,
    ...
    try {
      ...
      if (user != null) {
        try {
          ...
          print('✅ FCM token cleared for Device Wearer: ${user.uid}');
        } catch (e) {
      ...
      print('✅ Device Wearer logged out successfully');
        ...
        child: Column(
          ...
          children: [
            ...
            _buildSettingsTile(
                ...
                targetPage: const DevicePersonalInfo()),
            _buildSettingsTile(
                context: context,
                iconAsset: 'assets/pass.png',
                title: 'Password',
                targetPage: const DeviceEditPass()),
            _buildSettingsTile(
                context: context,
                iconAsset: 'assets/notif2.png',
                title: 'Notification Management',
                targetPage: const DeviceNotif2()),
            _buildSettingsTile(
                context: context,
                iconAsset: 'assets/locsharing.png',
                title: 'Location Sharing',
                targetPage: const DeviceLocshare()),
            _buildSectionHeader('Others'),
            _buildSettingsTile(
                context: context,
                iconAsset: 'assets/groupcircle.png',
                title: 'Circle Management',
                targetPage: const DeviceCircleM()),
            _buildSettingsTile(
                context: context,
            ...
            ListTile(
              ...
              trailing: Image.asset('assets/nextbutton.png',
                  width: 10.26, height: 12.91),
              onTap: () => _showDeviceLogoutOverlay(context),
            ),
          ],
        ),
      ),
    ...
    return ListTile(
      ...
      title: Text(title,
          style: GoogleFonts.poppins(
              ...
              color: const Color(0xFF1A1A1A))),
      trailing:
          Image.asset('assets/nextbutton.png', width: 10.26, height: 12.91),
      onTap: () {
        Navigator.push(
          context,
          PageRouteBuilder(
