...
class DevicePersonalInfo extends StatefulWidget {
  const DevicePersonalInfo({super.key});

  @override
  _DevicePersonalInfoState createState() => _DevicePersonalInfoState();
}

class _DevicePersonalInfoState extends State<DevicePersonalInfo> {
